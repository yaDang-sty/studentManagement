    ...
    <el-container style="height: 100vh; min-width: 1024px">
      <el-aside width="220px" class="app-aside">
        ...
        <el-menu :default-active="route.path" router background-color="#1d1e2c" text-color="#bfcbd9" active-text-color="#409eff">
          ...
          <el-menu-item index="/dormitory"><el-icon><HomeFilled /></el-icon><span>宿舍管理</span></el-menu-item>
          <el-menu-item index="/course"><el-icon><Reading /></el-icon><span>课程管理</span></el-menu-item>
          <el-menu-item index="/score"><el-icon><Edit /></el-icon><span>成绩管理</span></el-menu-item>
          <el-menu-item index="/stats"><el-icon><TrendCharts /></el-icon><span>成绩统计</span></el-menu-item>
        </el-menu>
      </el-aside>
      <div style="position: fixed; top: 14px; right: 20px; z-index: 999">
...
import { User, HomeFilled, Reading, Edit, TrendCharts } from "@element-plus/icons-vue";
